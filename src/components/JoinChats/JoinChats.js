  ...
  return (
    <div className="col-3 fh">
      <div className="list-container">
        <ChatSearch />
        <ul className="items">
          <li onClick={() => history.push('/chat/chat-1')} className="item">
          ...
          <li onClick={() => history.push('/chat/chat-2')} className="item">
            <div className="item-status">
              <img
                src="https://banner2.cleanpng.com/20180627/qvc/kisspng-the-legend-of-zelda-majora-s-mask-discord-compute-discord-icon-5b3371b7b55eb4.6840271215300981037429.jpg"
                alt="Retail Admin"
          ...
          <li onClick={() => history.push('/chat/chat-3')} className="item">
            <div className="item-status">
              <img
                src="https://banner2.cleanpng.com/20180627/qvc/kisspng-the-legend-of-zelda-majora-s-mask-discord-compute-discord-icon-5b3371b7b55eb4.6840271215300981037429.jpg"
                alt="Retail Admin"
          ...
          <li onClick={() => history.push('/chat/chat-4')} className="item">
            <div className="item-status">
              <img
                src="https://banner2.cleanpng.com/20180627/qvc/kisspng-the-legend-of-zelda-majora-s-mask-discord-compute-discord-icon-5b3371b7b55eb4.6840271215300981037429.jpg"
                alt="Retail Admin"
